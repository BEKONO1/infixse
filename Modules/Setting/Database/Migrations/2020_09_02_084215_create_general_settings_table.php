    ...
    public function up()
    {
        ...
        DB::table('general_settings')->insert([
            [
                ...
                'footer_copy_right' => 'Copyright © 2024 InfixLMS. All rights reserved | Made By  <a href="https://aorasoft.com" target="_blank"><span style="color:#BF37FF">CodeThemes</span></a>',                'created_at' => now(),
                'updated_at' => now(),
            ]
        ]);
